...
//
//     final movieDetailsModel = movieDetailsModelFromMap(jsonString);

import 'dart:convert';

MovieDetailsModel movieDetailsModelFromMap(String str) => MovieDetailsModel.fromMap(json.decode(str));

String movieDetailsModelToMap(MovieDetailsModel data) => json.encode(data.toMap());
